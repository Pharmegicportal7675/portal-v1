...
import { issueReachCertificateWithDetailsAction } from '@/actions/reach';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await issueReachCertificateWithDetailsAction(
      body.clientId.trim(),
    ...
    console.error('[api/reach/certificates/issue-details]', err);
    return NextResponse.json(
      {
        success: false,
