                      ...
                      <td className="px-6 py-4 text-center">
                        <div className="flex justify-center gap-2 items-center">
                          {app.bo_attachment_url && (
                            <a href={buildPoAttachmentPreviewUrl(app.id, app.bo_attachment_url) ?? '#'} target="_blank" rel="noopener noreferrer" title="View PO attachment">
            ...
            <>
              ...
              <div className="bg-slate-50 border rounded-lg p-3 text-xs space-y-1.5 text-slate-600 font-medium">
                ...
                {selectedTccApp?.bo_attachment_url && (
                  <a
                    href={buildPoAttachmentPreviewUrl(selectedTccApp.id, selectedTccApp.bo_attachment_url) ?? '#'}
                    target="_blank"
